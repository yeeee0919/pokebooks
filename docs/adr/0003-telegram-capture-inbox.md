...
Free-form replies go through a **smart turn** LLM that can handle unexpected corrections (currency, same-order multi-photo, clear vendor, etc.) while still refusing to post without an explicit confirm.
